...
Once your environment is prepared, go to the `conda_recipes` directory and execute the following command from your shell to submit a package build job for VRED 2025:
