...
- **Application**: Blender 4.5.0
- **Platform**: Windows 64-bit (win-64) & Linux 
- **Source**: https://download.blender.org/release/Blender4.5/blender-4.5.0-windows-x64.zip & https://download.blender.org/release/Blender4.5/blender-4.5.0-linux-x64.tar.xz
- **License**: GPL3
...
Have the activate script move them into Blender's Python. Change the deactivate to remove them. This way, you can make use of the environment variables that this recipe
