# Example scripts to reboot a Deadline Cloud Service Managed Worker

Worker reboots may be required for system configuration changes, such as installing new GPU device drivers or joining network domains.
