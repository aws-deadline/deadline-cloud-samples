<#
This is an example host configuration script that downloads and installs 3ds Max 2027, V-Ray for 3ds Max 2027, and tyFlow.
You can configure a Windows Service-Managed Fleet to use this host configuration to render your 3ds Max 2027 + V-Ray + tyFlow jobs.
This script was tested with the 3ds Max 2027, V-Ray for 3ds Max 2027, and tyFlow for 3ds Max 2027 installers.

Requirements:
- S3 bucket to host the 3ds Max 2027, V-Ray, and tyFlow installers
...
# TODO: Replace the below value with your S3 URI from your bucket
$TYFLOW_PLUGIN_S3_URI="s3://your-bucket-name/path/to/tyFlow_2027_render.dlo"
...
$tyflowFile = Split-Path $TYFLOW_PLUGIN_S3_URI -Leaf
aws s3 cp --no-progress "$TYFLOW_PLUGIN_S3_URI" "$pluginsDir\$tyflowFile"
