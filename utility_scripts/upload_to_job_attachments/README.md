...
5. **Manifest Generation**: Creates JSON manifest with file paths, hashes, sizes, and modification times
...
- JSON manifest file with complete upload details
...
[2/5] Collecting files from 2 path(s)...
